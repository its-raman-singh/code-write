...
const workExperienceData = [
  {
    ...
    endDate: "August 2025",
    companyName: "KCC Institute of Technology and Management",
    jobTitle: "B.Tech",
    description: [
  ...
  },
  {
    startDate: "",
    endDate: "April 2022",
    companyName: "Sityog Institute of Technology",
    jobTitle: "Diploma in Mechanical Engineering",
    description: [
...
const Education = () => {
  return (
    <div className="flex flex-col gap-8 w-full">
      <h1 className="text-2xl font-bold mb-2 text-green-600 mt-1">Education</h1>
